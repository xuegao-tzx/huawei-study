...
# 保留自定义类
-keep class com.xcl.jianjia.slice.BianQian.first.**{*;}
-keep class com.xcl.jianjia.slice.BianQian.WatchOnly.**{*;}
-keep class com.xcl.jianjia.slice.BianQian.second.**{*;}
-keep class com.xcl.jianjia.MyApplication
-keep class com.xcl.jianjia.net.**{*;}
# 忽略数据库有关
...
-keep class com.xcl.jianjia.Data.**{*;}
# 忽略继承
